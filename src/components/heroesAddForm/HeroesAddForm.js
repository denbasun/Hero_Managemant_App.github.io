...
const HeroesAddForm = () => {
    ...
    const onSubmitHandler = (e) => {
        ...
        request("https://my-json-server-github-io.onrender.com/heroes", "POST", JSON.stringify(newHero))
    ...
    return (
        <form onSubmit ={onSubmitHandler} className="border p-4 shadow-lg rounded">
            ...
            <div className="mb-3">
                <label htmlFor="element" className="form-label">Assign power element to hero</label>
                <select 
                    required
                    ...
                    <option value="">I have the magic power of...</option>
